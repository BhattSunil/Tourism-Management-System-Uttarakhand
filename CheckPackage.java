...
public class CheckPackage extends JFrame{
    ...
    CheckPackage() {    
      ...
      setVisible(true);
      String[] package1 = new String[]{"Pack1.jpg","PURNAGIRI PACKAGE","2 Days", "Full Assistance", "Half Day Tanakour City Tour", "Trekking", "Daily Buffet", "Sharda River View", "Brahmadev Temple Visit (Nepal)", "BOOK NOW", "Special Offer", "Rs 3000 only"};
      String[] package2 = new String[]{"pack2.jpeg","REETHA SAHIB","2 days Tour", "Trekking", "Local Guide Available", "Daily Buffet", "Historical Gurudwara Visit", "Full Assistance", "River View", "BOOK NOW", "Winter Special", "Rs 4500 only"};
      String[] package3 = new String[]{"packkk.jpg","SHYAMALATAL","1 Day Tour", "Guide Available", "Boating Included, Horse Riding", "Welcome drinks on Arrival", "Daily Buffet", "Stay on Hotel", "Lunch Included", "BOOK NOW", "Winter Special", "Rs 2000 only"};
